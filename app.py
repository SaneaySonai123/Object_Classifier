...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_three = simpledialog.askstring("Classname Three", "Enter the name of the Third class:",parent=self.window)       #change
        ...
        self.btn_class_three = tk.Button(self.window, text=self.classname_three, width=50, command=lambda: self.save_for_class(3))         #change
    ...
    def save_for_class(self, class_num):
        ...
        if not os.path.exists("2"):
            os.mkdir("2")
        if not os.path.exists("3"):                       #change
            os.mkdir("3")
